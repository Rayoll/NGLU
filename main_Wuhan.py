...
def parse_args():
    ...
    parser.add_argument('--city',type=str,default='wuhan',help='experimental city')
    ...
    parser.add_argument('--lr',type=float,default=1e-4,help='cinitial learning rate')
...
def main(args):
    ...
    gt = pd.read_csv('./data/wuhan_label_gt.txt')
    ...
    aoi_poi_dataset = AOI_POI_Sample_Dataset(
        filepath=r'Path of the Wuhan center dataset',
